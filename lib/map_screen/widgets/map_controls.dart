...
class MapControls extends StatelessWidget {
  ...
  final double bottomPadding; // Add bottom padding parameter
  ...
  const MapControls({
    ...
    this.bottomPadding = 0.0, // Default to no padding
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        Positioned(
          bottom: 140 + bottomPadding, // Adjusted position with padding
          left: 20,
        ...
        Positioned(
          bottom: 50 + bottomPadding, // Adjusted position with padding
          right: 20,
