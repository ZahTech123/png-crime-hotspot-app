...
class _ReportsPageState extends State<ReportsPage> {
  ...
  Map<String, int> _getComplaintCountsByStatus(List<Complaint> complaints) {
   ...
   Map<String, int> _getComplaintCountsByPriority(List<Complaint> complaints) {
  ...
  Map<String, int> _getComplaintCountsByDirectorate(List<Complaint> complaints) {
    Map<String, int> counts = {};
    for (var complaint in complaints) {
       counts.update(complaint.directorate, (value) => value + 1, ifAbsent: () => 1);
    }
  ...
  Widget _buildKPIs(List<Complaint> complaints) {
  ...
  Widget _buildStatusChart(List<Complaint> complaints) {
  ...
  Widget _buildPriorityChart(List<Complaint> complaints) {
   ...
   Widget _buildDirectorateChart(List<Complaint> complaints) {
